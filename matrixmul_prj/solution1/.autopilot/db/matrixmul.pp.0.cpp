...
__attribute__((sdx_kernel("matrixmul", 0))) void matrixmul(
      mat_a_t a[3][3],
      mat_b_t b[3][3],
...
__attribute__((sdx_kernel("matrixmul", 0))) void matrixmul(
      ...
      result_t res[3][3],
   result_t res1[3][3])
{_ssdm_SpecArrayDimSize(a, 3);_ssdm_SpecArrayDimSize(b, 3);_ssdm_SpecArrayDimSize(res, 3);_ssdm_SpecArrayDimSize(res1, 3);
#pragma HLS TOP name=matrixmul
# 55 "matrixmul.cpp"
