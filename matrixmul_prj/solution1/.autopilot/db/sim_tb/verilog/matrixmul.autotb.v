...
`define AESL_MEM_res1 AESL_automem_res1
`define AESL_MEM_INST_res1 mem_inst_res1
...
`define AUTOTB_TVIN_res1  "./c.matrixmul.autotvin_res1.dat"
...
`define AUTOTB_TVIN_res1_out_wrapc  "./rtl.matrixmul.autotvin_res1.dat"
`define AUTOTB_TVOUT_res  "./c.matrixmul.autotvout_res.dat"
`define AUTOTB_TVOUT_res1  "./c.matrixmul.autotvout_res1.dat"
`define AUTOTB_TVOUT_res_out_wrapc  "./impl_rtl.matrixmul.autotvout_res.dat"
`define AUTOTB_TVOUT_res1_out_wrapc  "./impl_rtl.matrixmul.autotvout_res1.dat"
module `AUTOTB_TOP;
...
wire [15 : 0] res_d0;
wire [15 : 0] res_q0;
wire [3 : 0] res1_address0;
wire  res1_ce0;
wire  res1_we0;
wire [15 : 0] res1_d0;
wire [3 : 0] res1_address1;
wire  res1_ce1;
wire [15 : 0] res1_q1;
integer done_cnt = 0;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .res_d0(res_d0),
    .res_q0(res_q0),
    .res1_address0(res1_address0),
    .res1_ce0(res1_ce0),
    .res1_we0(res1_we0),
    .res1_d0(res1_d0),
    .res1_address1(res1_address1),
    .res1_ce1(res1_ce1),
    .res1_q1(res1_q1));
...
assign arrayres_ready= ready;
assign arrayres_done = interface_done;


//------------------------arrayres1 Instantiation--------------

// The input and output of arrayres1
wire    arrayres1_ce0, arrayres1_ce1;
wire [2 - 1 : 0]    arrayres1_we0, arrayres1_we1;
wire    [3 : 0]    arrayres1_address0, arrayres1_address1;
wire    [15 : 0]    arrayres1_din0, arrayres1_din1;
wire    [15 : 0]    arrayres1_dout0, arrayres1_dout1;
wire    arrayres1_ready;
wire    arrayres1_done;

`AESL_MEM_res1 `AESL_MEM_INST_res1(
    .clk        (AESL_clock),
    .rst        (AESL_reset),
    .ce0        (arrayres1_ce0),
    .we0        (arrayres1_we0),
    .address0   (arrayres1_address0),
    .din0       (arrayres1_din0),
    .dout0      (arrayres1_dout0),
    .ce1        (arrayres1_ce1),
    .we1        (arrayres1_we1),
    .address1   (arrayres1_address1),
    .din1       (arrayres1_din1),
    .dout1      (arrayres1_dout1),
    .ready      (arrayres1_ready),
    .done    (arrayres1_done)
);

// Assignment between dut and arrayres1
assign arrayres1_address0 = res1_address0;
assign arrayres1_ce0 = res1_ce0;
assign arrayres1_we0[0] = res1_we0;
assign arrayres1_we0[1] = res1_we0;
assign arrayres1_din0 = res1_d0;
assign arrayres1_address1 = res1_address1;
assign arrayres1_ce1 = res1_ce1;
assign res1_q1 = arrayres1_dout1;
assign arrayres1_we1 = 0;
assign arrayres1_din1 = 0;
assign arrayres1_ready= ready;
assign arrayres1_done = interface_done;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.matrixmul.autotvout_res1.dat", "r");
    fp2 = $fopen("./impl_rtl.matrixmul.autotvout_res1.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.matrixmul.autotvout_res1.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.matrixmul.autotvout_res1.dat\"!");
    else begin
        $display("Comparing rtl.matrixmul.autotvout_res1.dat with impl_rtl.matrixmul.autotvout_res1.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
reg dump_tvout_finish_res1;

initial begin : dump_tvout_runtime_sign_res1
    integer fp;
    dump_tvout_finish_res1 = 0;
    fp = $fopen(`AUTOTB_TVOUT_res1_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_res1_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    // last transaction is saved at negedge right after last done
    repeat(5) @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_res1_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_res1_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
