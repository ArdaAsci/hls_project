...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("res_q0", 16, hls_in, 2, "ap_memory", "mem_dout", 1),
	Port_Property("res1_address0", 4, hls_out, 3, "ap_memory", "mem_address", 1),
	Port_Property("res1_ce0", 1, hls_out, 3, "ap_memory", "mem_ce", 1),
	Port_Property("res1_we0", 1, hls_out, 3, "ap_memory", "mem_we", 1),
	Port_Property("res1_d0", 16, hls_out, 3, "ap_memory", "mem_din", 1),
	Port_Property("res1_address1", 4, hls_out, 3, "ap_memory", "MemPortADDR2", 1),
	Port_Property("res1_ce1", 1, hls_out, 3, "ap_memory", "MemPortCE2", 1),
	Port_Property("res1_q1", 16, hls_in, 3, "ap_memory", "MemPortDOUT2", 1),
};
