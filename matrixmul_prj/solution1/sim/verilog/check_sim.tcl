...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matrixmul.autotvin_a.dat"
         "c.matrixmul.autotvin_b.dat"
         "c.matrixmul.autotvin_res.dat"
         "c.matrixmul.autotvin_res1.dat"
         "c.matrixmul.autotvout_res.dat"
         "c.matrixmul.autotvout_res1.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matrixmul.autotvout_res.dat"
         "rtl.matrixmul.autotvout_res1.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
