...
// ==============================================================
# 1 "/home/asci/vivado/vitis_rl/matrixmul.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/asci/vivado/vitis_rl/matrixmul.cpp"
# 46 "/home/asci/vivado/vitis_rl/matrixmul.cpp"
...
# 42 "/tools/Xilinx/Vitis_HLS/2021.1/tps/lnx64/gcc-6.2.0/include/c++/6.2.0/cmath" 2 3
...
# 43 "/tools/Xilinx/Vitis_HLS/2021.1/tps/lnx64/gcc-6.2.0/include/c++/6.2.0/cmath" 2 3
...
# 44 "/tools/Xilinx/Vitis_HLS/2021.1/tps/lnx64/gcc-6.2.0/include/c++/6.2.0/cmath" 2 3
...
void matrixmul(
      ...
      result_t res[3][3],
   result_t res1[3][3]);
# 47 "/home/asci/vivado/vitis_rl/matrixmul.cpp" 2
   ...
   result_t res1[3][3])
{
   ...
   Row: for(int i = 0; i < 3; i++) {
    ...
    Row1: for(int i = 0; i < 3; i++) {

       Col2: for(int j = 0; j < 3; j++) {
          res1[i][j] += res[i][j]*res[i][j];
       }
    }
}
#ifndef HLS_FASTSIM
...
extern "C"
#endif
void apatb_matrixmul_ir(char (*)[3], char (*)[3], short (*)[3], short (*)[3]);
#ifdef __cplusplus
extern "C"
#endif
void matrixmul_hw_stub(char (*a)[3], char (*b)[3], short (*res)[3], short (*res1)[3]){
matrixmul(a, b, res, res1);
return ;
}
#ifdef __cplusplus
extern "C"
#endif
void apatb_matrixmul_sw(char (*a)[3], char (*b)[3], short (*res)[3], short (*res1)[3]){
apatb_matrixmul_ir(a, b, res, res1);
return ;
}
#endif
# 75 "/home/asci/vivado/vitis_rl/matrixmul.cpp"
